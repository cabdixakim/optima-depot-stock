...
return new class extends Migration {
    public function up(): void {
        Schema::create('offloads', function (Blueprint $t) {
            $t->id();
            $t->date('date');
            ...
            $t->decimal('delivered_observed_l', 12, 3)->nullable();
            $t->decimal('delivered_20_l', 12, 3)->default(0);
            $t->decimal('shortfall_20_l', 12, 3)->default(0);
            $t->decimal('depot_allowance_20_l', 12, 3)->default(0);

            $t->decimal('temperature_c', 5, 2)->nullable();
            $t->decimal('density_kg_l', 6, 4)->nullable();
            $t->string('rsv')->nullable();
    ...
    public function down(): void { Schema::dropIfExists('offloads'); }
};
